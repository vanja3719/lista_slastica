...
export default function ResetPassword() {
    ...
    return (
        <div class="flex items-center justify-center min-h-[70vh] py-8">
            <div class="brutalist-card p-8 md:p-10 max-w-md w-full relative z-10">
                <h1 class="text-4xl font-black uppercase tracking-tighter mb-8 w-full text-center title-font text-white bg-black inline-block p-2">Oporavak</h1>

                <Message message={error()} type="error" />

                <Show when={!success()}>
                    <form class="flex flex-col gap-6" onSubmit={handleSubmit}>
                        <p class="text-sm text-center mb-2 font-bold opacity-80">
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary w-full">Pošalji na E-mail</button>
                        </div>
                    </form>
                </Show>
